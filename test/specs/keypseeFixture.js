...
(function (Keypsee, scope, describe, it, xit, expect, beforeEach, spyOn, console) {
    ...
    describe("Keypsee", function () {
        ...
        describe('observe', function () {
            describe('when given a key-pattern to observe (i.e. ctrl+b)', function () {
            ...
            describe('when given a key-pattern with multiple modifiers to observe (i.e. ctrl+command+b)', function () {
            ...
            describe('when given multiple key-patterns to observe (i.e. ctrl+b, command+b)', function () {
            ...
            describe('when events that match observed key-patterns are triggered', function () {
                ...
                it('should execute each callback that matches the key-pattern for each registered handler', function (done) {
                    // given
                    var random = getRandomString(),
                        notYetDefined,
                        notYetDefined2,
